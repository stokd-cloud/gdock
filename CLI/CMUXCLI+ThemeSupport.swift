...
extension CMUXCLI {
    ...
    private func bundleIdentifierForThemeReloadSocketPath(_ socketPath: String) -> String? {
        ...
        case "cmux-debug.sock":
            return "cloud.stokd.ghostty-dock.debug"
        case "cmux-nightly.sock":
            return "cloud.stokd.ghostty-dock.nightly"
        case "cmux-staging.sock":
            return "cloud.stokd.ghostty-dock.staging"
        default:
            break
        }
    ...
    func isRightSidebarCLIMode(_ value: String) -> Bool {
        ...
        case "files", "find", "vault", "sessions", "feed", "dock", "work", "stokd-work":
            return true
        default:
            return false
        }
    ...
    func normalizedRightSidebarCLIArgument(_ value: String) -> String {
        switch value.lowercased() {
        case "files", "find", "vault", "sessions", "feed", "dock", "work":
