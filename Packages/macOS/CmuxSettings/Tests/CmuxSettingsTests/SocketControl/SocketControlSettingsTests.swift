...
@Suite struct SocketControlSettingsTests {
    ...
    @Test func taggedDevBuildDetection() {
        #expect(SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "cloud.stokd.ghostty-dock.debug.my-tag"))
        #expect(!SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "cloud.stokd.ghostty-dock.debug"))
        #expect(!SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "cloud.stokd.ghostty-dock"))
    }
