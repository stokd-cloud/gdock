...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "betaFeatures:sidebar-dock": localized("settings.search.alias.setting.betaFeatures.sidebar-dock", defaultValue: "sidebar.beta.dock.enabled sidebar dock spaces rails collapsible sections left right beta"),
