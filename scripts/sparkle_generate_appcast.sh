...
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-https://github.com/stokd-cloud/ghostty-dock/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-https://github.com/stokd-cloud/ghostty-dock/releases/tag/$TAG}"
