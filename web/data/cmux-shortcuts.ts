...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "autoSplit", combos: [["⌘", "Y"]], description: { en: "Auto Split into the configured rows × columns grid", ja: "設定した行×列のグリッドに自動分割" } },
      { id: "gdock.nextQuadPane", combos: [], description: { en: "Create next quad pane (unbound by default; Auto Split uses ⌘Y)", ja: "次のクアッドペインを作成（既定では未割り当て。自動分割は ⌘Y）" } },
